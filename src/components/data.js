...
export const about =
  "500+ projects deep and still going deeper in the mobile & web app development space. From A to Z of building beautiful apps, we do everything in-house, Epic coder's style.";
export const services = [
  {
    ...
    description:
      "Enhancing product images to make them look more appealing and professional, which can be crucial for e-commerce businesses and marketing campaigns.",
    descriptionOverview:
      "Edit Product/ecommerce photos and make them Amazon or catalog-worthy. (e.g: Jewellery, Shoes, Bags, etc.)",
    ...
    additionalData: {
      ...
      types: {
        description:
          "We offer an extensive range of product editing services tailored to meet your specific requirements. Our expertise extends to assisting with over 500+ products, ensuring that each one receives meticulous attention.",
        list: [
          "Color Correction",
          "Color Variants",
          "Reflection Addition",
  ...
  },
  {
    ...
    description:
      "Improving the quality and visual appeal of images through various editing techniques, such as color correction, retouching, and cropping.",
    descriptionOverview:
      "Sky Replacement, White Balancing, Sharpening, Lens correction, Tone Adjustment, Lawn Enhancement, Flash &  Reflection Removal, etc",
    ...
    additionalData: {
      ...
      types: {
        description:
          "Welcome to Pixobrew, your comprehensive creative partner. We are here to elevate your visuals across a wide spectrum of services that cater to every need.",
        list: [
          "White Balancing",
          "Sharpening",
          "Remove Blemishes",
  ...
  },
  {
    ...
    description:
      " Adding virtual furniture and decor to empty spaces, making them more attractive and inviting for potential buyers or renters.",
    descriptionOverview:
      "clutter removal, interior and exterior virtual renovation/remodeling",
    ...
    additionalData: {
      ...
      types: {
        description:
          "We provide a wide array of virtual staging services to suit your specific needs.",
        list: [
          "Residential Staging",
          "Commercial Staging",
          "Interior Concepts",
  ...
  },
  {
    ...
    title: "Day to Dusk",
    description:
      "Transforming daytime photos into captivating dusk or twilight scenes, adding a different mood and atmosphere to the images.",
    ...
    additionalData: {
      ...
      types: {
        description:
          "We provide a wide array of day to dusk services to suit your specific needs.",
        list: [
  ...
  },
  {
    ...
    title: "Item Removal",
    description:
      "Removing unwanted objects or elements from images to create a clean and polished final result.",
    descriptionOverview:
      "Removes unwanted items without leaving any trace of editing.",
    ...
    additionalData: {
      ...
      types: {
        description:
          "We provide a wide array of item removal services to suit your specific needs.",
        list: [
          "Background Cleanup",
          "Object Erasure",
          "Blemish  Removal",
  ...
  },
  {
    ...
    description:
      "Creating realistic 3D renders of architectural designs and providing floor plans for real estate projects.",
    descriptionOverview:
      "3D rendering, 2D/3D floor plans and Site plans renders",
    ...
    additionalData: {
      ...
      types: {
        description:
          "We provide a wide array of rendering services to suit your specific needs.",
        list: [
          "Interior Design",
          "Outdoor Design",
...
export const videoServices = [
  {
    title: "Video Editing",
    description:
      "Editing and arranging video footage to create compelling and engaging videos for various purposes.",
  },
  {
    title: "VFX",
    description:
      "Incorporating computer-generated visual effects into videos or images to achieve stunning and eye-catching results.",
  },
  {
    title: "Sound-FX",
    description:
      "Adding sound effects to videos to enhance the overall audiovisual experience.",
  },
  {
    title: "Compositing",
    description:
      "Combining multiple images or video elements to create a seamless and cohesive final composition.",
  },
  {
    title: "Motion Graphics",
    description:
      " Designing and animating graphic elements to add movement and visual interest to videos or presentations.",
  },
  {
    title: "Animation",
    description:
      "Creating animated sequences or characters to convey messages or tell stories effectively.",
  },
];
